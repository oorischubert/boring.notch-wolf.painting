...
extension Defaults.Keys {
    ...
    static let releaseName = Key<String>("releaseName", default: "Oori Schubert 🥶")
    ...
    static let enableFullscreenMediaDetection = Key<Bool>(
        "enableFullscreenMediaDetection", default: true)
    ...
    static let systemEventIndicatorUseAccent = Key<Bool>(
        "systemEventIndicatorUseAccent", default: false)
    ...
    static let calendarSelectionState = Key<CalendarSelectionState>(
        "calendarSelectionState", default: .all)
